...
channel.postRequest('MapModulePlugin.AddMarkerRequest', [markerData, '{{MARKER_ID}}']);
    ...
    <h3>Marker events</h3>
    <p>
      <InlineCode>AfterAddMarkerEvent</InlineCode> event is triggered when a marker has been added
      to map. The event provides an id for the marker that was added.
    </p>
    <CodeSnippet> { "id": "{{ MARKER_ID }}" } </CodeSnippet>
    <DocumentationLink type="event" apiDoc="mapping/mapmodule/event/AfterAddMarkerEvent.md">
      Documentation for AfterAddMarkerEvent
    </DocumentationLink>
    <p><!-- Just to provide a bit of white space... --></p>

    <p>
      <InlineCode>MarkerClickEvent</InlineCode> event is triggered when a marker is clicked on the
      map. The event provides an id for the marker that was clicked.
    </p>
    <CodeSnippet> { "id": "{{ MARKER_ID }}" } </CodeSnippet>
    <DocumentationLink type="event" apiDoc="mapping/mapmodule/event/MarkerClickEvent.md">
      Documentation for MarkerClickEvent
    </DocumentationLink>
    <p><!-- Just to provide a bit of white space... --></p>
